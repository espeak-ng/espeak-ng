...
list(APPEND ESPEAK_RUN_ENV "ESPEAK_DATA_PATH=${DATA_DIST_ROOT}")
# if building with CMAKE_CROSSCOMPILING use the NativeBuild of espeak-ng
if(NATIVEBUILD)
  set(ESPEAK_RUN_CMD ${CMAKE_COMMAND} -E env ${ESPEAK_RUN_ENV} $ENV{VALGRIND} "${NATIVEBUILD}")
  set(ESPEAK_BIN_DEP "")
else()
  set(ESPEAK_RUN_CMD ${CMAKE_COMMAND} -E env ${ESPEAK_RUN_ENV} $ENV{VALGRIND} "$<TARGET_FILE:espeak-ng-bin>")
