...
public class SupportedLanguagesPreference extends MultiSelectListPreference {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        mNewValues.clear();
        mNewValues.addAll(values);

        mCheckedItems = new boolean[mDialogEntryValues.length];
        ...
        for (int i = 0; i < mDialogEntryValues.length; i++) {
            boolean checked = values.contains(mDialogEntryValues[i].toString());
        ...
        mListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            final String value = mDialogEntryValues[position].toString();
            if (checked) {
